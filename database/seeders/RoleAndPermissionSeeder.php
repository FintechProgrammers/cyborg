...
class RoleAndPermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'credit wallet', 'guard_name' => 'admin']);
        Permission::create(['name' => 'debit wallet', 'guard_name' => 'admin']);
        Permission::create(['name' => 'manage transactions', 'guard_name' => 'admin']);
        Permission::create(['name' => 'manage trade', 'guard_name' => 'admin']);
        Permission::create(['name' => 'manage strategy', 'guard_name' => 'admin']);
        Permission::create(['name' => 'create strategy', 'guard_name' => 'admin']);
        Permission::create(['name' => 'delete strategy', 'guard_name' => 'admin']);
        Permission::create(['name' => 'update strategy', 'guard_name' => 'admin']);
        ...
        $defaultRole->syncPermissions([
            'manage user','manage transactions','manage trade','manage strategy'
        ]);
