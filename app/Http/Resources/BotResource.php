...
class BotResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'trade_values' => [
                'position_amount'   => !empty($trade_Values->position_amount) ? number_format($trade_Values->position_amount,2) : 0,
                ...
                'trade_price'       => !empty($trade_Values->trade_price) ? number_format($trade_Values->trade_price,2) : 0,
